(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('@angular/animations'), require('rxjs/operators'), require('@angular/platform-browser/animations'), require('@fortawesome/free-solid-svg-icons/faCheckCircle'), require('@fortawesome/free-solid-svg-icons/faExclamationCircle'), require('@fortawesome/free-solid-svg-icons/faExclamationTriangle'), require('@fortawesome/free-solid-svg-icons/faInfoCircle'), require('@fortawesome/angular-fontawesome')) :
    typeof define === 'function' && define.amd ? define('@hangar42/ngx-toast-it', ['exports', '@angular/core', 'rxjs', '@angular/common', '@angular/animations', 'rxjs/operators', '@angular/platform-browser/animations', '@fortawesome/free-solid-svg-icons/faCheckCircle', '@fortawesome/free-solid-svg-icons/faExclamationCircle', '@fortawesome/free-solid-svg-icons/faExclamationTriangle', '@fortawesome/free-solid-svg-icons/faInfoCircle', '@fortawesome/angular-fontawesome'], factory) :
    (global = global || self, factory((global.hangar42 = global.hangar42 || {}, global.hangar42['ngx-toast-it'] = {}), global.ng.core, global.rxjs, global.ng.common, global.ng.animations, global.rxjs.operators, global.ng.platformBrowser.animations, global.faCheckCircle, global.faExclamationCircle, global.faExclamationTriangle, global.faInfoCircle, global.angularFontawesome));
}(this, function (exports, core, rxjs, common, animations, operators, animations$1, faCheckCircle, faExclamationCircle, faExclamationTriangle, faInfoCircle, angularFontawesome) { 'use strict';
    ...
    var ToastItService = /** @class */ (function () {
        function ToastItService() {
            this.activeToasts$ = new rxjs.Subject();
            this.activeConfig$ = new rxjs.Subject();
        }
        /**
         * @param {?} config
         * @return {?}
        ...
        /** @nocollapse */ ToastItService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ToastItService_Factory() { return new ToastItService(); }, token: ToastItService, providedIn: "root" });
    ...
    var ToastContainerComponent = /** @class */ (function () {
        function ToastContainerComponent(toastService) {
            ...
            this.activeToasts$ = new rxjs.BehaviorSubject([]);
            this.toastCountStream$ = new rxjs.BehaviorSubject(0);
            this.config = new ToastConfig();
            this.toastCount$ = this.toastCountStream$.pipe(operators.filter((/**
             * @param {?} count
             * @return {?}
             */
        ...
        function (toasts) {
            ...
            this.toasts$ = rxjs.from(toasts).pipe(operators.take(groupingThreshold), operators.toArray());
    ...
    var ToastComponent = /** @class */ (function () {
        function ToastComponent() {
            var _this = this;
            this.style = {};
            this.destroyEmitter = new core.EventEmitter();
            this.destroy = (/**
             * @return {?}
             */
        ...
        function () {
            switch (this.toast.type) {
                ...
                case 'toast--info':
                    return faInfoCircle.faInfoCircle;
                case 'toast--warning':
                    return faExclamationTriangle.faExclamationTriangle;
                case 'toast--error':
                    return faExclamationCircle.faExclamationCircle;
            }
        };
        /**
         * @private
        ...
        ToastComponent.propDecorators = {
            ...
            toastCount: [{ type: core.Input }],
            destroyEmitter: [{ type: core.Output }]
        };
    ...
    var ComponentInjectorService = /** @class */ (function () {
        ...
        /** @nocollapse */ ComponentInjectorService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ComponentInjectorService_Factory() { return new ComponentInjectorService(core.ɵɵinject(core.ComponentFactoryResolver), core.ɵɵinject(core.ApplicationRef), core.ɵɵinject(core.INJECTOR)); }, token: ComponentInjectorService, providedIn: "root" });
    ...
    var ProgressBarComponent = /** @class */ (function () {
        ...
        function () {
            ...
            rxjs.interval(REFRESH_RATE)
                .pipe(operators.take(amountOfMarblesUntilFinished))
                .subscribe((/**
             * @return {?}
             */
    ...
    exports.ToastItModule = ToastItModule;
    exports.ToastItService = ToastItService;
    exports.ToastPosition = ToastPosition;
    exports.ToastType = ToastType;
    exports.ɵa = ToastComponent;
    exports.ɵb = ToastContainerComponent;
    exports.ɵc = ProgressBarComponent;
    exports.ɵd = ComponentInjectorService;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=hangar42-ngx-toast-it.umd.js.map
